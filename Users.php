...
<head>
    ...
    <title>Users - eHealth Mate</title>
                        ...
                        <div class="card-body">
                            <table id='record_table' class='table table-hover'>
                                ...
                                <?php 
                                        ...
                                        $sql = "SELECT id, f_name, m_name, last_name, username, password FROM tbl_users";
                                        $id = "SELECT id FROM tbl_users";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <a class='btn btn-danger' href='functions/delete_user.php?id=".$row['id']."'>DELETE</a>
                                                    </td>
                                                </tr>";
                                            }
                                            // echo "</table>";
            ...
            $.ajax({
                ...
                success: function(response){
                    if (response.status === true){
                        ...
                        $('#employee_num').val(response.data[0].employee_no);
